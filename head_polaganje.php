<?php
		$pl7="m. od ispita, moći ćete prijaviti polaganje. Osvježavanje vaše lokacije svakih 15 sekundi";
...
var clng;
	...
	if(distanc < .<?php echo $radijus; ?>){
     document.location = "index.php?page=kurcina&lat="+lat+"&lokacija=<?php echo $lokacija_id; ?>";
		}else{
